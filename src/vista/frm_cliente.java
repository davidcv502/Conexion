...
public void selec_datos(){
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        obj_cliente = new Cliente(Integer.parseInt(lbl_id.getText())/*Integer.valueOf(lbl_id.getText())*/ ,txt_nit.getText(),txt_nombres.getText(),txt_apellidos.getText(),txt_direccion.getText(),txt_telefono.getText(),txt_fn.getText());
